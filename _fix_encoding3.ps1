...
'@
[IO.File]::WriteAllText("$base\service\impl\HrmRecruitServiceImpl.java", $recruitImpl, (New-Object System.Text.UTF8Encoding $false))
...
'@
[IO.File]::WriteAllText("$base\service\impl\HrmResumeServiceImpl.java", $resumeImpl, (New-Object System.Text.UTF8Encoding $false))
...
'@
[IO.File]::WriteAllText("$base\service\impl\HrmAttendanceServiceImpl.java", $attendanceImpl, (New-Object System.Text.UTF8Encoding $false))
...
'@
[IO.File]::WriteAllText("$base\service\impl\HrmLeaveServiceImpl.java", $leaveImpl, (New-Object System.Text.UTF8Encoding $false))

Write-Host "Service impls part 1 fixed!"
